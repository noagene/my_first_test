...
/**
 * Created by Kimsj on 2016. 3. 2..
 */
public abstract class HeaderRecyclerViewAdapter<V> extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (position == 0 && holder.getItemViewType() == TYPE_HEADER) {
            ...
            onBindBasicItemViewHolder(holder, position - (useHeader() ? 1 : 0));
        }
    }
